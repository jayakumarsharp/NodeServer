...
var EstimationServionProductsModel = {

    //Get PricesheetbyOppId
    GetEstimationServionProducts: function (oppId) {
        var deferred = q.defer();
        try {
            logger.info('price sheet called')
            if (oppId != null && oppId != undefined) {
                models.EstimationServionProducts.findAll({ where: { OppId: oppId } })
            ...
            models.OppApplicationMap.findAll({ where: { ApplicationId: GroupId, OppId: OppId } })
                .then(function (opp) {
                    if (opp.length > 0) {
                        ...
                        models.OppApplicationMap.findAll({ where: { OppId: OppId, SheetName: 'ServionProductsSheet' } })
                            .then(function (opp) {
                                if (opp.length > 0) {
                                    ...
                                    models.sequelize.transaction().then(function (t) {
                                        if (t != null && t != undefined) {
                                            ...
                                            sequelize.query('insert into TBL_EstimationServionProducts (OppId,GroupType,Name,col1,col2,col3,Name1,Fcol1,Fcol2,Fcol3,Fcol4,Fcol5,Fcol6,RowId,A1col1,A1col2,A1col3,A1Fcol1,A1Fcol2,A1Fcol3,A1Fcol4,A1Fcol5,A1Fcol6,GroupId) select :OppId,EM.GroupType,EM.Name,EM.col1,EM.col2,EM.col3,EM.Name1,EM.Fcol1,EM.Fcol2,EM.Fcol3,EM.Fcol4,EM.Fcol5,EM.Fcol6,EM.RowId,A1col1,A1col2,A1col3,A1Fcol1,A1Fcol2,A1Fcol3,A1Fcol4,A1Fcol5,A1Fcol6,:groupid from TBL_EstimationServionProductsMaster EM left outer join TBL_EstimationServionProducts EA on EM.RowId=EA.Rowid and (EA.GroupId = :groupid or EA.GroupId is null)', { replacements: { OppId: OppId, groupid: GroupId }, type: sequelize.QueryTypes.SELECT, transaction: t })
                                                .then(function () {
                                                    ...
                                                    models.OppApplicationMap.create({
                                                        ...
                                                        IsLocked: true,
                                                        IsEditable: true,
                                                        LockedIn: 'ServionProductsSheet',
                                                        SheetName: 'ServionProductsSheet',
                                                        LockedUser: username,
                                                        LockStartTime: localTime,
                                                        CreatedBy: username,
    ...
    GetMaximumGroupEstimationServionProductsId: function () {
        var deferred = q.defer();
        try {
    ...
    AddEstimationServionProducts: function (EstimationModel) {
        var deferred = q.defer();
        try {
            ...
            models.sequelize.transaction().then(function (t) {
                if (t != null && t != undefined) {
                    if (EstimationModel.IsSaveAs) {
                        models.OppApplicationMap.findAll({ where: { OppId: EstimationModel.OppId, SheetName: 'ServionProductsSheet', IsLocked: true } })
                            .then(function (opp) {
                                if (opp.length > 0) {

                                    if (opp[0].LockedUser == EstimationModel.Authour) {

                                        sequelize.query('update TBL_EstimationOppMapping set IsEditable=0,IsLocked=0,LockedIn=NULL,LockedUser=NULL,LockStartTime=NULL where OppId = :id and SheetName=:sheetname', { replacements: { id: EstimationModel.OppId, sheetname: "ServionProductsSheet" }, type: sequelize.QueryTypes.SELECT, transaction: t })
                                            .then(function () {
                                                models.OppApplicationMap.create({
                                                    OppId: EstimationModel.OppId, ApplicationId: EstimationModel.ApplicationId, Version: EstimationModel.Version, IsEditable: EstimationModel.IsReadOnly, CreatedBy: EstimationModel.Authour, Comment: EstimationModel.Comment, LockedIn: '', NumberOfApplication: EstimationModel.NumberofApp, SheetName: 'ServionProductsSheet'
                                                }, { transaction: t })
                                                    .then(function () {
                        ...
                        models.OppApplicationMap.update({
                            ...
                            .then(function () {
                                models.EstimationServionProducts.destroy({ where: { GroupId: EstimationModel.ApplicationId }, truncate: false }, { transaction: t })
                                    .then(function () {
                                        Addinternalcall(EstimationModel, t, deferred);
                                    })
    ...
    AddEstimationServionProductsNewVersion: function (EstimationModel) {
        var deferred = q.defer();
        try {
                ...
                models.OppApplicationMap.findAll({ where: { OppId: EstimationModel.OppId } })
                    .then(function (opp) {
                        if (opp.length > 0) {
                            ...
                            models.OppApplicationMap.create({
                                OppId: EstimationModel.OppId, ApplicationId: EstimationModel.ApplicationId, Version: EstimationModel.Version, IsEditable: EstimationModel.IsReadOnly, CreatedBy: EstimationModel.Authour, Comment: EstimationModel.Comment, LockedIn: '', NumberOfApplication: EstimationModel.NumberofApp, SheetName: 'ServionProductsSheet', IsInitial: true
                            }, { transaction: t })
                                .then(function () {
                                    sequelize.query('insert into TBL_EstimationServionProducts (OppId,GroupType,Name,col1,col2,col3,Name1,Fcol1,Fcol2,Fcol3,Fcol4,Fcol5,Fcol6,RowId,A1col1,A1col2,A1col3,A1Fcol1,A1Fcol2,A1Fcol3,A1Fcol4,A1Fcol5,A1Fcol6,GroupId) select EA.OppId,EM.GroupType,EM.Name,EM.col1,EM.col2,EM.col3,EM.Name1,EM.Fcol1,EM.Fcol2,EM.Fcol3,EM.Fcol4,EM.Fcol5,EM.Fcol6,EM.RowId,A1col1,A1col2,A1col3,A1Fcol1,A1Fcol2,A1Fcol3,A1Fcol4,A1Fcol5,A1Fcol6,:groupid from TBL_EstimationServionProductsMaster EM left outer join TBL_EstimationServionProducts EA on EM.RowId=EA.Rowid  and (EA.GroupId = :oldid or EA.GroupId is null)', { replacements: { oldid: EstimationModel.ExisitingPriceGroupId, groupid: EstimationModel.ApplicationId }, type: sequelize.QueryTypes.SELECT, transaction: t })
                                        .then(function () {
                                            t.commit();
    ...
    GetAllEstimationServionProductsbyOppGroupID: function (oppId, ApplicationId) {
        var deferred = q.defer();
        try {
            models.OppApplicationMap.findAll({ where: { ApplicationId: ApplicationId } })
                .then(function (opp) {
                    if (opp.length > 0) {
                        if (opp[0].IsEditable) {
                            sequelize.query('SELECT SP.[Id],[OppId],SPM.[GroupType],SPM.[Name],SPM.[col1],SPM.[col2],SPM.[col3],SPM.[Name1],SPM.[Fcol1],SPM.[Fcol2],SPM.[Fcol3],SPM.[Fcol4],SPM.[Fcol5],SPM.[Fcol6],SPM.[RowId],[A1col1],[A1col2],[A1col3],[A1Fcol1],[A1Fcol2],[A1Fcol3],[A1Fcol4],[A1Fcol5],[A1Fcol6],[GroupId]  FROM  TBL_EstimationServionProductsMaster SPM left outer join [dbo].[TBL_EstimationServionProducts] SP  on SP.RowId =SPM.RowId where GroupId= :groupid or GroupId is null', { replacements: { groupid: ApplicationId }, type: sequelize.QueryTypes.SELECT })
                            ...
                            models.EstimationServionProducts.findAll({ where: { GroupId: ApplicationId } })
...
module.exports.EstimationServionProductsModel = EstimationServionProductsModel;
...
function Addinternalcall(ApplicationModel, t, deferred) {
    try {
        ...
        if (t != null && t != undefined) {
            ...
            models.EstimationServionProducts.bulkCreate(ApplicationModel.ServionProductsSheet, { transaction: t }, { omitNull: true }).then(function () {
                t.commit();
...
function UpdateFormuleusingSP(GroupId, deferred) {
    ...
    connection.connect(function (err) {
        ...
        request.execute('proc_UpdateEstimationServionProducts', function (err, recordsets, returnValue) {
            if (err) {
                logger.info('SP Execution Error on proc_UpdateEstimationServionProducts');
                closeConnection(connection, 'proc_UpdateEstimationServionProducts');
                logger.info('ex' + err);
                deferred.reject(err)
            }
            closeConnection(connection, 'proc_UpdateEstimationServionProducts');
